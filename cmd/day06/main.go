...
func main() {
	...
	// takes around AAA (drawn with lines) is only partly shown. In the map
	...
	// chain can be any number of objects long: if A orbits B, B orbits C, and C
	...
	// What is the total number of direct and indirect orbits in your map data? (below)
	uni := ParseUniverse(myMapData)
	Part1("%d", uni.SumOrbits())
	...
	Part2("%d", uni.CountTransfersBetween("YOU", "SAN"))
}

var myMapData string = `XNR)9W1
VGS)XCW
WS5)5XM
T9F)RTN
RQ8)67Q
